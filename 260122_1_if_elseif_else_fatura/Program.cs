namespace _260122_1_if_elseif_else_fatura
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            4- Harcanan 275-400 (dahil) ise ilk 275 kw için 250 TL, 275 kw ı geçen her kw başına 1.25 kr kesaplanacak 
            5- Harcanan 400-600 (dahil) ise ilk 400 kw için 430 TL, 400 kw ı geçen her kw başına 1.45 kr kesaplanacak 
            6-600 kw geçen hesaplama için ilk 600 kw için 750 TL, 600 kw ı geçen her kw başına 1.55 hesaplacak şekilde toplam fatura ne kadar olacağını hesaplayan ve ekranda gösteren yapıyı kodlayınız???
            */

            // SORU-1:
            BASLA:
            double fatura;
            Console.WriteLine("Aylık elektrik harcama bilgisi (kw):");
