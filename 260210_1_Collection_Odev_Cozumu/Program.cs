...
namespace _260210_1_Collection_Odev_Cozumu
{
    internal class Program
    {
        static void Main(string[] args)
        {
            /* Kullanıcıdan alınan adı, soyadı, doğum tarihi, cinsiyet, medeni durum, aylık gelir gibi işlemleri bir ArrayList içinde kullanarak kullanıcıya bir kart
             oluşturup kullanıcıya gösteriniz.
