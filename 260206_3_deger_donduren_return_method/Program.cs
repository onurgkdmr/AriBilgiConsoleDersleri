    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // int islem1 = ToplaVoiad(s1 , s2); // void method olduğu için bir değişkene eşitlenmez, hata verir.
        ...
        static int Topla(int sayi1,int sayi2) // İsimden önce int var, değer döndüren.
        {
            int toplam = sayi1 + sayi2;
            Console.WriteLine("2 sayının toplamı:" + toplam);
            return toplam; // int ile belirtilen method return ile min int (daha küçük değer aralığına sahip veri tipleri de yazılabilir) değer alan değişken, sayı verilmelidir. return ile beraber method sonlanır, bundan dolayı return un yazıldığı yer çok önemlidir.
        }
